...
class Transaction extends Model {
  ...
  const Transaction._internal(
      ...
      : _type = type,
        ...
        _transactionReceiverId = transactionReceiverId,
        _transactionSenderId = transactionSenderId;
  ...
  String toString() {
    ...
    buffer.write("dateTime=" +
        (_dateTime != null ? _dateTime!.format() : "null") +
        ", ");
    ...
    buffer.write(
        "balance=" + (_balance != null ? _balance!.toString() : "null") + ", ");
    buffer.write("failType=" +
        (_failType != null ? enumToString(_failType)! : "null") +
        ", ");
  ...
  Transaction copyWith(
    ...
    return Transaction._internal(
        ...
        transactionReceiverId:
            transactionReceiverId ?? this.transactionReceiverId,
        transactionSenderId: transactionSenderId ?? this.transactionSenderId);
  }

  Transaction.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        _type = enumFromString<TransactionType>(
            json['type'], TransactionType.values),
        _amount = (json['amount'] as num?)?.toDouble(),
        _status = enumFromString<TransactionStatus>(
            json['status'], TransactionStatus.values),
        _dateTime = json['dateTime'] != null
            ? TemporalDateTime.fromString(json['dateTime'])
            : null,
        _receiver = json['receiver']?['serializedData'] != null
            ? Wallet.fromJson(new Map<String, dynamic>.from(
                json['receiver']['serializedData']))
            : null,
        _sender = json['sender']?['serializedData'] != null
            ? Wallet.fromJson(
                new Map<String, dynamic>.from(json['sender']['serializedData']))
            : null,
        _txId = json['txId'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'gpTxId': _gpTxId,
        'balance': _balance,
        'failType': enumToString(_failType),
        'createdAt': _createdAt?.format(),
        'updatedAt': _updatedAt?.format(),
        'transactionReceiverId': _transactionReceiverId,
        'transactionSenderId': _transactionSenderId
      };
  ...
  static final QueryModelIdentifier<TransactionModelIdentifier>
      MODEL_IDENTIFIER = QueryModelIdentifier<TransactionModelIdentifier>();
  ...
  static final QueryField RECEIVER = QueryField(
      fieldName: "receiver",
      fieldType:
          ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'Wallet'));
  ...
  static final QueryField TRANSACTIONRECEIVERID =
      QueryField(fieldName: "transactionReceiverId");
  static final QueryField TRANSACTIONSENDERID =
      QueryField(fieldName: "transactionSenderId");
  static var schema =
