...
class WithdrawAssetBody extends StatefulWidget {
  final Map<String, dynamic> goldApiRateData;

  const WithdrawAssetBody({
    Key? key,
    required this.goldApiRateData,
  }) : super(key: key);

  @override
  State<WithdrawAssetBody> createState() => _WithdrawAssetBodyState();
}

class _WithdrawAssetBodyState extends State<WithdrawAssetBody> {
